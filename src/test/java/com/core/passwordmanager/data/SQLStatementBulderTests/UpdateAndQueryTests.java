package com.core.passwordmanager.data.SQLStatementBulderTests;

import com.core.passwordmanager.data.DatabaseConfig;
import com.core.passwordmanager.data.SQLStatementBuilder;
...
public class UpdateAndQueryTests {
    ...
    public void testInsertEntry() throws SQLException {
        ...
        PreparedStatement statement = sqlStatementBuilder.prepareInsertEntryStatement(
                "testTitle", "test@example.com", "password123", "testUser", "http://example.com", "General"
        );
    ...
    public void testGetEntry() throws SQLException {
        ...
        String title = "testTitle", email = "test@example.com", password = "password123";
        ...
        PreparedStatement getEntryStatement = sqlStatementBuilder.prepareGetEntryStatement("testTitle");
    ...
    public void testUpdateEntry() throws SQLException {
        ...
        // Constant vars for this entry
        String title = "testTitle", password = "password123";
        String username = "testUser", link = "http://example.com", category = "General";
        ...
        PreparedStatement updateStatement = sqlStatementBuilder.prepareEntryUpdateStatement(
                "testTitle", newEmail, null, null, null, null);
    ...
    public void testGetAllEntryTitles() throws SQLException {
        ...
        String title1 = "testTitle1", email1 = "test@example.com1", password1 = "password1";
        String username1 = "testUser1", link1 = "http://example.com1", category1 = "General1";

        String title2 = "testTitle2", email2 = "test@example.com2", password2 = "password2";
        String username2 = "testUser2", link2 = "http://example.com2", category2 = "General2";

        String title3 = "testTitle3", email3 = "test@example.com3", password3 = "password3";
        String username3 = "testUser3", link3 = "http://example.com3", category3 = "General3";

        String title4 = "testTitle4", email4 = "test@example.com4", password4 = "password4";
        String username4 = "testUser4", link4 = "http://example.com4", category4 = "General4";

        String title5 = "testTitle5", email5 = "test@example.com5", password5 = "password5";
